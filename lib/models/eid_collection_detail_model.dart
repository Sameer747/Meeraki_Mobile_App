...
EidCollectionDetails featureDetailsFromJson(String str) =>
    EidCollectionDetails.fromJson(json.decode(str));

String featureDetailsToJson(EidCollectionDetails data) =>
    json.encode(data.toJson());

class EidCollectionDetails {
  EidCollectionDetails({
    required this.data,
  ...
  factory EidCollectionDetails.fromJson(Map<String, dynamic> json) =>
      EidCollectionDetails(
