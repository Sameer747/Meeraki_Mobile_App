...
class EidBuildBottomSheet extends StatefulWidget {
  late EidCollectionDetails data;
  late String size;
  EidBuildBottomSheet({required this.data, required this.size});

  @override
  State<EidBuildBottomSheet> createState() => _EidBuildBottomSheetState();
}

class _EidBuildBottomSheetState extends State<EidBuildBottomSheet> {
